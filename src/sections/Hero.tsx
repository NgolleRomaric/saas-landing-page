        ...
        <section className="py-24 overflow-x-clip">
            <div className="container relative">
                <div className="absolute -left-52 top-16 hidden lg:block">
                    <Image src={designExemple1Image} alt="Design example 1" />
                </div>
                <div className="absolute -right-64 -top-16 hidden lg:block">
                    <Image src={designExemple2Image} alt="Design example 2" />
                </div>
                <div className="absolute left-40 top-96  hidden lg:block">
                    <Pointer name="Andrea" />
                </div>
                <div className="absolute right-72 -top-4  hidden lg:block">
                ...
                <p className="text-center text-xl text-white/50 mt-8 max-w-2xl mx-auto">
                    ...
                    powerful feature with an intuitive interface that keeps you
